...
<img src="https://capsule-render.vercel.app/api?type=venom&color=0:050510,40:0d0820,100:0a0a1a&height=360&section=header&text=PARTH%20GHOLAP&fontSize=88&fontAlignY=38&animation=fadeIn&fontColor=D4AF6E&desc=Software%20Engineer%20%7C%20Full%20Stack%20Developer%20%7C%20Automation%20Architect&descSize=17&descAlignY=58&stroke=B8962E&strokeWidth=1.5" width="100%"/>
...
**✦ BRAIN QUEST**
*Interactive Learning & Gamification Platform*

```
Stack    →  HTML5 · CSS3 · JavaScript · Web API
Feature  →  Dynamic quiz engine & engaging UI
Journey  →  Designed to make learning fun & adaptive
Status   →  🚀 Shipped & Live
```

[![Visit](https://img.shields.io/badge/LIVE%20SITE-00C851?style=flat-square&labelColor=0d0820)](https://brain-quest-jet.vercel.app)
...
```
Stack    →  n8n · Python · SpecKit · REST APIs
Feature  →  Low-code logic chaining + automation
Journey  →  Optimizing business and app tasks
Status   →  ✅ Tested & Functional
```

[![GitHub](https://img.shields.io/badge/SOURCE-D4AF6E?style=flat-square&labelColor=0d0820&logo=github&logoColor=D4AF6E)](https://github.com/parth-gholap)
...
```
Award    →  🏆 4th Place (National Level)
Focus    →  Collaborative developer solution
Team     →  Coordinated dev cycles to ship project
```
...
**✦ SolVIT HACKATHON**
*Solve-it Dev Challenge*

```
Award    →  🎯 Final Round Qualifier
Focus    →  High-pressure problem solving
Challenge→  Pushed limits in design & efficiency
```
